...
For example, you'll notice how the first spec file (`bu`) first `require`s the `Robot` class (via `require 'robot'`) and then using RSpec it runs a suite of position and movement related tests against that class.
